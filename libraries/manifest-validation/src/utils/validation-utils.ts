...
export function isValidRelatedApp(app: RelatedApplication){
  if(!possiblePlatforms.includes(app.platform)){
    return "platform";
  } 
...
const possiblePlatforms: Array<String> = ["windows", "chrome_web_store", "play", "itunes", "webapp", "f-droid", "amazon"]
